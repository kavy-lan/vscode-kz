    ...
    try {
        ...
        var convertRule = {
            ...
            'setNavigationBarTitle': {
                'replacement': 'setNavigationBar',
                'tips': '请迁移至my.setNavigationBar完成标题设置',
                'link': apiDocPrefix + '/ui-navigate#a-nameh86sstamysetnavigationbar'
            },
...
function convertWxml(src, target, done) {
    ...
    content = content.replace(/bindscrolltolower/g, "onScrollToLower");
